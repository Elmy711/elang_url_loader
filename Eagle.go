...
func printBanner() {
	...
	// Durasi animasi total:
	// Loops: 10
	// Sleep per char: 10ms
	// Sleep between char animation: 120ms
	// Sleep between full banner display: 100ms
	// Total = 10 * (len(banner)*10ms + 120ms + 100ms)
	// Approx = 10 * (14*10ms + 120ms + 100ms) = 10 * (140ms + 220ms) = 10 * 360ms = 3.6 seconds
